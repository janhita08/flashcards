//Janhita Chakravarty and Ethan Hang
...
public class Flashcard{
  ...
  //method to allow users to flip the cards after they learn the definitions
  ...
  //method to allow users to quiz themselves by studying the cards 
  public void studyCards(){
    ...
    for(int i = 0; i < flashcards[0].length; i++){
      ...
      //keeps track of how many cards are correct
      ...
      //picks a random card for user to study each time
      do{
  ...
  //method to allow user to add new cards to their set
  ...
  //method to allow user to remove cards from their set
  ...
  //method to allow user to edit cards in their set
  ...
  //method to allow user to print out their set
